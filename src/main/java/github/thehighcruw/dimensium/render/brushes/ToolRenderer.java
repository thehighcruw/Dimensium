 ...
 * {@link github.thehighcruw.dimensium.tool.ToolRegistry}.
...
public interface ToolRenderer {
    ...
    /**
     * Called from {@link github.thehighcruw.dimensium.render.world.SelectionRenderer} once per world-render tick
    ...
    /**
     * Per-frame overlay update called from {@link github.thehighcruw.dimensium.render.OverlayRenderer} once per render
