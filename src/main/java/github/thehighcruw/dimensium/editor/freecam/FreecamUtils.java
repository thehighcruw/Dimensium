...
public class FreecamUtils {
    ...
    public static MovingObjectPosition rayTrace(Minecraft mc, double reach) {
        ...
        if (cam != null) {
            ...
            Vec3 end = Vec3.createVectorHelper(
                    cam.posX + dir.xCoord * reach, cam.posY + dir.yCoord * reach, cam.posZ + dir.zCoord * reach);
    ...
    public static Vec3DDouble[] cameraBasis(float yawDeg, float pitchDeg) {
        ...
        return new Vec3DDouble[] {
            Vec3DDouble.from(-sy * cp, -sp, cy * cp),
            Vec3DDouble.from(cy, 0, sy),
